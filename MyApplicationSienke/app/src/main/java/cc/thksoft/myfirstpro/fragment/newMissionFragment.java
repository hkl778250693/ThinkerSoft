...
import cc.thksoft.myfirstpro.lvadapter.NewMissionDataAdapter;
...
import example.android_cbjactivity.ActualMissionNEW;
...
public class newMissionFragment extends Fragment implements OnClickListener {
	...
	private void guiwdaget() {
		...
		new_mission_listview.setMode(Mode.PULL_FROM_START);// ����ˢ��ģʽ ���� ���� Ĭ������
