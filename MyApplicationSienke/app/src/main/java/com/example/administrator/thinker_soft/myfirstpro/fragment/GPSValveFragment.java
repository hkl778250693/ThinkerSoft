...
import com.example.administrator.thinker_soft.myfirstpro.lvadapter.WheelViewAdapter;
...
import com.example.administrator.thinker_soft.myfirstpro.wheel.WheelView;
...
public class GPSValveFragment extends Fragment implements OnClickListener {
	...
	private void guiwadget() {
		...
		gps_valve_fragment_lv.setMode(RefreshPullToRefreshBase.Mode.PULL_FROM_START);// ����ˢ��ģʽ ���� ���� Ĭ������
