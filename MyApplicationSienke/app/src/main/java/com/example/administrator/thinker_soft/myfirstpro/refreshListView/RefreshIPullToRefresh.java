...
public interface RefreshIPullToRefresh<T extends View> {
     ...
     */
    public RefreshPullToRefreshBase.Mode getCurrentMode();
     ...
     */
    public RefreshPullToRefreshBase.Mode getMode();
     ...
     */
    public RefreshPullToRefreshBase.State getState();
     ...
     */
    public void setMode(RefreshPullToRefreshBase.Mode mode);
     ...
     *            propogate.
     */
    public void setOnPullEventListener(RefreshPullToRefreshBase.OnPullEventListener<T> listener);
     ...
     */
    public void setOnRefreshListener(RefreshPullToRefreshBase.OnRefreshListener<T> listener);
     ...
     *            - Listener to be used when the Widget is set to Refresh
     */
    public void setOnRefreshListener(RefreshPullToRefreshBase.OnRefreshListener2<T> listener);
