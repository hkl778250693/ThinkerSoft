...
public class RefreshIndicatorLayout extends FrameLayout implements AnimationListener {
...
//	private ImageView mArrowImageView;
	...
	public RefreshIndicatorLayout(Context context, RefreshPullToRefreshBase.Mode mode) {
		super(context);
