...
public abstract class RefreshLoadingLayout extends LinearLayout {
    ...
    public RefreshLoadingLayout(Context context, final RefreshPullToRefreshBase.Mode mode, final int scrollDirection, TypedArray attrs, boolean topsignal, boolean bottomsignal) {
        super(context);
        ...
        case RefreshPullToRefreshBase.HORIZONTAL_SCROLL:
            LayoutInflater.from(context).inflate(R.layout.refresh_pull_to_refresh_header_horizontal, this);
            mMaxWidth = getResources().getDimensionPixelSize(R.dimen.header_footer_max_width);
            break;

        case RefreshPullToRefreshBase.VERTICAL_SCROLL:
        default:
            LayoutInflater.from(context).inflate(R.layout.refresh_pull_to_refresh_header_vertical, this);
            mMaxWidth = getResources().getDimensionPixelSize(R.dimen.header_footer_max_width);
            break;
        ...
        case PULL_FROM_END:
            // Load in labels
        	if(bottomsignal==true){//bottomsignalΪtrue������������ء�
                mPullLabel = context.getString(R.string.pulldown_to_loading);
                mRefreshingLabel = context.getString(R.string.refreshing);
                mReleaseLabel = context.getString(R.string.release_to_update);
        	}else{//bottomsignalΪfalse���������ˢ�¡�
                mPullLabel = context.getString(R.string.pulldown_to_loading_);
                mRefreshingLabel = context.getString(R.string.refreshing_);
                mReleaseLabel = context.getString(R.string.release_to_update_);
        	}
            break;
        ...
        default:
            // Load in labels
        	if(topsignal==true){//topsignalΪtrue������������ء�
                mPullLabel = context.getString(R.string.pull_to_refresh_pull_label);
                mRefreshingLabel = context.getString(R.string.pull_to_refresh_refreshing_label);
                mReleaseLabel = context.getString(R.string.pull_to_refresh_release_label);
        	}else{//topsignalΪfalse���������ˢ�¡�
                mPullLabel = context.getString(R.string.pull_to_refresh_pull_label_);
                mRefreshingLabel = context.getString(R.string.pull_to_refresh_refreshing_label_);
                mReleaseLabel = context.getString(R.string.pull_to_refresh_release_label_);
        	}
            break;
        }
        ...
        case PULL_FROM_START:
            if (attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableStart)) {
                ...
                RefreshUtils.warnDeprecation("ptrDrawableTop", "ptrDrawableStart");
        ...
        case PULL_FROM_END:
            if (attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableEnd)) {
                ...
                RefreshUtils.warnDeprecation("ptrDrawableBottom", "ptrDrawableEnd");
        ...
        if (null == imageDrawable) {
            if (mode == RefreshPullToRefreshBase.Mode.PULL_FROM_START) {
