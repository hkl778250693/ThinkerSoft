...
public abstract class RefreshPullToRefreshAdapterViewBase<T extends AbsListView> extends RefreshPullToRefreshBase<T> implements
        OnScrollListener {
    ...
    private RefreshIndicatorLayout mIndicatorIvTop;
    private RefreshIndicatorLayout mIndicatorIvBottom;

    private boolean mShowIndicator;
    private boolean mScrollEmptyView = true;

    public RefreshPullToRefreshAdapterViewBase(Context context) {
        super(context);
        mRefreshableView.setOnScrollListener(this);
    }

    public RefreshPullToRefreshAdapterViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRefreshableView.setOnScrollListener(this);
    }

    public RefreshPullToRefreshAdapterViewBase(Context context, Mode mode) {
        super(context, mode);
        mRefreshableView.setOnScrollListener(this);
    }
     ...
     * if {@link RefreshPullToRefreshBase#isPullToRefreshOverScrollEnabled()
    ...
    /**
     * Pass-through method for {@link RefreshPullToRefreshBase#getRefreshableView()
    ...
    public final void setEmptyView(View newEmptyView) {
        ...
        if (null != newEmptyView) {
            ...
            if (mRefreshableView instanceof RefreshEmptyViewMethodAccessor) {
                ((RefreshEmptyViewMethodAccessor) mRefreshableView).setEmptyViewInternal(newEmptyView);
            } else {
    ...
    private void addIndicatorViews() {
        ...
        if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
            ...
            mIndicatorIvTop = new RefreshIndicatorLayout(getContext(), Mode.PULL_FROM_START);
        ...
        if (mode.showFooterLoadingLayout() && null == mIndicatorIvBottom) {
            // If the mode can pull down, and we don't have one set already
            mIndicatorIvBottom = new RefreshIndicatorLayout(getContext(), Mode.PULL_FROM_END);
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
            params.rightMargin = getResources().getDimensionPixelSize(R.dimen.indicator_right_padding);
