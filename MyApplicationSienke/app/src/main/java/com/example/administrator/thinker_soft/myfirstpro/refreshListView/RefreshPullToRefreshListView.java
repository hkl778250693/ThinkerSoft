...
// com.example.weibo_sina.view.refresh.PullToRefreshListView
public class RefreshPullToRefreshListView extends
        RefreshPullToRefreshAdapterViewBase<ListView> {

    private RefreshLoadingLayout mHeaderLoadingView;

    private RefreshLoadingLayout mFooterLoadingView;

    private FrameLayout mLvFooterLoadingFrame;

    private boolean topSignal = true, bottomSignal = true;//�Լ����

    public RefreshPullToRefreshListView(Context context) {
        super(context);
        setDisableScrollingWhileRefreshing(false);
    }

    public RefreshPullToRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setDisableScrollingWhileRefreshing(false);
    }

    public RefreshPullToRefreshListView(Context context, RefreshPullToRefreshBase.Mode mode) {
        super(context, mode);
        setDisableScrollingWhileRefreshing(false);
    }
    ...
    @Override
    public void setLoadingDrawable(Drawable drawable, RefreshPullToRefreshBase.Mode mode) {
    ...
    public void setPullLabel(CharSequence pullLabel, RefreshPullToRefreshBase.Mode mode) {
    ...
    public void setRefreshingLabel(CharSequence refreshingLabel, RefreshPullToRefreshBase.Mode mode) {
    ...
    public void setReleaseLabel(CharSequence releaseLabel, RefreshPullToRefreshBase.Mode mode) {
    ...
    void onRefreshing(final boolean doScroll) {
        ...
        final RefreshLoadingLayout origLoadingView, listViewLoadingView, oppositeListViewLoadingView;
    ...
    @Override
    void onReset() {
        final RefreshLoadingLayout originalLoadingLayout, listViewLoadingLayout;
        ...
        if (listViewLoadingLayout.getVisibility() == View.VISIBLE) {
             ...
             */
            if (scrollLvToEdge && getState() != RefreshPullToRefreshBase.State.MANUAL_REFRESHING) {
                mRefreshableView.setSelection(selection);
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.RefreshPullToRefreshListView);
        topSignal = array.getBoolean(R.styleable.RefreshPullToRefreshListView_topsignal, true);
        bottomSignal = array.getBoolean(R.styleable.RefreshPullToRefreshListView_bottomsignal, true);
        array.recycle();
        ...
        mHeaderLoadingView = createLoadingLayout(context, RefreshPullToRefreshBase.Mode.PULL_FROM_START,
                a, topSignal, bottomSignal);
        frame.addView(mHeaderLoadingView, lp);
        lv.addHeaderView(frame, null, false);
        mLvFooterLoadingFrame = new FrameLayout(context);
        mFooterLoadingView = createLoadingLayout(context, RefreshPullToRefreshBase.Mode.PULL_FROM_END, a, topSignal, bottomSignal);
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
            ...
            RefreshOverscrollHelper.overScrollBy(
                    RefreshPullToRefreshListView.this, deltaX, scrollX, deltaY,
    ...
    protected class InternalListView extends ListView implements
            RefreshEmptyViewMethodAccessor {
        ...
        public void setEmptyView(View emptyView) {
            RefreshPullToRefreshListView.this.setEmptyView(emptyView);
        }
