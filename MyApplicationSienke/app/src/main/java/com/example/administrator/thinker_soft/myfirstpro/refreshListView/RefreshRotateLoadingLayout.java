...
public class RefreshRotateLoadingLayout extends RefreshLoadingLayout {
  ...
  public RefreshRotateLoadingLayout(Context context, RefreshPullToRefreshBase.Mode mode, int scrollDirection, TypedArray attrs, boolean topsignal, boolean bottomsignal) {
