...
public class Global {
	...
	public static String toast_success = "成功";
	public static String toast_fail = "失败";
	public static String toast_notconnect = "请连接打印机";
	public static String toast_usbpermit = "请允许应用程序使用USB和reclick这个按钮";
	public static String toast_connecting = "正在连接：";
}
